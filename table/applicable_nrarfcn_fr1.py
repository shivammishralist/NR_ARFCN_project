...
class Table:
    def __init__(self, table_id, table_release_3gpp, table_ts, table_name, table_header, table_data):
        self.table_id = table_id
        self.table_release_3gpp = table_release_3gpp
        self.table_ts = table_ts
